...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Qodha Admin</div>
    </a>
    ...
    <li class="nav-item @if (Route::is('produk')) active @endif">
    ...
    <li class="nav-item @if (Route::is('testimoni')) active @endif">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Buat Baru:</h6>
                <a class="collapse-item" href="{{ route('buat') }}">Produk</a>
                <a class="collapse-item" href="{{ route('buatkategori') }}">Category</a>
                <a class="collapse-item" href="{{ route('buattesti') }}">Testimoni</a>
                <a class="collapse-item" href="{{ route('buatfaq') }}">FAQ</a>
            </div>
        </div>
    </li>
