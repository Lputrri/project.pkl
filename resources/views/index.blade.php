...
<header>
    <nav class="container navbar navbar-expand-md navbar-dark">
        <a class="navbar-brand" href="#">Qodha.Id</a>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a href="https://www.facebook.com/qodhaaromatic?mibextid=ZbWKwL" target="_blank" class="nav-link">
                        <i class="fa fa-facebook-f"></i>
                    </a>
                </li>
                <li>
                    <a href="https://instagram.com/qodha.id?igshid=YmMyMTA2M2Y=" target="_blank" class="nav-link">
                        <i class="fa fa-instagram"></i>
                    </a>
                </li>
                <li>
                    <a href="https://github.com/lputrri/" target="_blank" class="nav-link">
                        <i class="fa fa-github"></i>
                    </a>
                </li>
                <li>
                    <a href="https://wa.me/6281717302223" target="_blank" class="nav-link">
    ...
    <div class="container hero text-center text-white">
        <div class="row">
            <div class="col-sm-12 mt-5 mb-5">
                ...
                <h1 class="mt-4 hero-title">Cari Aromaterapi dengan harga terjangkau?</h1>
                <p class="mt-4">
                    Qodha aromaterapi aja, aromaterapi berkualitas original dengan aroma kekinian dengan harga murah, plus banyak promonya!
                </p>
                <a href="#product-first" class="btn mybtn mb-5 mt-3 px-5">Lihat Produk</a>
                <div class="pb-5"></div>
                <div class="pb-2"></div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-3 mt-3">
                <div class="radius mt-8">
                    ...
                    <h2 class="text-white">Dupa kerucut</h2>
                    <div class="pt-3"></div>
                    <p class="text-white">
                        Dupa kerucut yang wangi nya bikin relax dan tahan lama.
                    </p>
    ...
    <div class="container mt-5 pt-5 pb-5">
        <div class="row">
            <div class="col-sm-9 col-sm-offset-3 mt-3 order-2 order-sm-1">
                <div class="swiper-container">
                    <div class="swiper-wrapper pt-4 pb-5">
                        @foreach ($hioharum as $hio)


                        <div class="swiper-slide pl-1 pr-1">
                            <div class="shadow bg-white rounded-lg radius detail-brosur p-2">
                                <a href="#">
                                    <img src="{{ $hio->gambar }}" class="w-100" style="margin-top:10px;">
                                </a>
                                <div class="rating text-center mt-3 mb-4">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
            ...
            <div class="col-sm-3 mt-3 order-1 order-sm-2">
                <div class="radius mt-8">
                    <div class="pt-5 spacing5"></div>
                    <div class="bg-white mb-4" style="width: 120px;padding: 2px;"></div>
                    <h2 class="text-white">Hio harum</h2>
                    <div class="pt-3"></div>
                    <p class="text-white">
                        Dengan varian aroma yang beragam bikin hari kamu makin relax
                    </p>
                    <div class="prev bg-white border next-btn mt-4" style="font-size: 10pt;">
                        <i class="fa fa-angle-left"></i>
                    </div>
...
<footer>
    <div class="container-fluid text-center text-white py-5" style="background: #2B2AAC;">
        <h2 class="text-center text-white mb-2">Qodha.id</h2>
        <div class="social my-3">
            <a href="https://www.facebook.com/qodhaaromatic?mibextid=ZbWKwL" target="_blank">
                <i class="fa fa-facebook-f"></i>
            </a>
            <a href="https://instagram.com/qodha.id?igshid=YmMyMTA2M2Y=" target="_blank">
                <i class="fa fa-instagram"></i>
            </a>
            <a href="https://github.com/lputrri/" target="_blank">
                <i class="fa fa-github"></i>
            </a>
            <a href="https://wa.me/6281717302223" target="_blank">
                <i class="fa fa-whatsapp"></i>
            </a>
        </div>
        <p>
            By <a href="#" class="text-white mt-2">lidia prasetya</a>
        </p>
    </div>
</footer>
